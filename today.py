...
USER_NAME = os.environ.get('USER_NAME', 'HAMZOO0')
...
if __name__ == '__main__':
    """
    Hamza Sajid (HAMZOO0) — adapted from Andrew Grant's (Andrew6rant) today.py
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 1, 1)) # TODO: set your real birthday (year, month, day)
